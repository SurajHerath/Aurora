...
public class Appointment {
    ...
    public Appointment(String a_ID, String p_ID, String e_ID, Date a_Date, Time a_time,String t_ID, double reg_Fee, double t_Price, String a_Status,int schedule_ID, int time_range_ID) {
        this.a_ID = a_ID;
        this.p_ID = p_ID;
        this.e_ID = e_ID;
        this.a_Date = a_Date;
