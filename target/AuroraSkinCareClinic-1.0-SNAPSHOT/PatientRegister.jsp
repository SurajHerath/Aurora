<%-- 
    Document   : CheckAppoinments
    Created on : Oct 20, 2024, 12:42:09 PM
    Author     : suraj
--%>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="appointment-form">
                                ...
                                <form id="addPatientForm" method="POST" action="PatientController?action=add"></form>

                                <div class="container">
                                    <label><b>NIC NO.</b></label>
                                    <input type="text" name="p_NIC" class="form-control my-1" placeholder="Enter NIC Number" required>
                                    <label><b>Patient ID</b></label>
                                    <input type="text" name="p_ID" class="form-control my-1" placeholder="Enter ID number" required>
                                    <label><b>First Name</b></label>
                                    <input type="text" name="p_FirstName" class="form-control my-1" placeholder="Enter First Name" required>
                                    <label><b>Middle Name</b></label>
                                    <input type="text" name="p_MiddleName" class="form-control my-1" placeholder="Enter Middle Name">
                                    <label><b>Last Name</b></label>
                                    <input type="text" name="p_LastName" class="form-control my-1" placeholder="Enter Last Name" required>
                                    <label><b>Phone Number</b></label>
                                    <input type="text" name="p_Phone_Number" class="form-control my-1" placeholder="Enter Phone Number" required>
                                    <label><b>Email Address</b></label>
                                    <input type="email" name="p_Email" class="form-control my-1" placeholder="Enter Email Address" required>
                                    <br>
                                    <input type="submit" value="Add Patient" class="btn btn-success container mt-3">
                                </div>
                                </form>
                                <!-- if patient allraedy reg then serch by name or Nic then serch and if its is avilable then re direct to appoinmnet registry form -->
                                <br>
                                <br>
                                <br>
                            </div>
