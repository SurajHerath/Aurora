<%-- 
    ...
    Created on : Nov 3, 2024, 5:47:54 AM
    Author     : suraj
--%>
...
<html lang="en">
    <head>
        ...
        <title>Add Schedule - Aurora Skin Care Clinic</title>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="appointment-form">
                                <h2 class="text-center mb-4">Add Your Schedule</h2>


                                
                                  <form id="addScheduleForm" method="POST" action="ScheduleController?action=add">  
                                    <div class="container">

                                        <label><b>Dermatologist ID</b></label>
                                        <input type="text" name="dermatologistID" class="form-control my-1" placeholder="Enter Dermatologist ID" required>
                                        ...
                                        <input type="time" name="startTime" class="form-control my-1" required>

                                        <label><b>End Time</b></label>
                                        <input type="time" name="endTime" class="form-control my-1" required>

                                        <br>
                                        <input type="submit" value="Add Schedule" class="btn btn-success container mt-3">
                                    </div>
                                </form>
                            </div>
                        </div>
